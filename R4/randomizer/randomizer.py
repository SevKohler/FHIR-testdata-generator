...
class RandomFHIRDates:
    def next(self):
        ...
        return DateTime(randint(1915, 2019), int(month),  int(day),  int(hour),  int(minute),  int(second))
...
class RandomVariant:
    def next(self):
        ...
        variant[0][
            "variantPointer"] = "None"  # would need an observation but the observation also needs a sequence -> paradox
        return variant
