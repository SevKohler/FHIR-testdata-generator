...
from random import *
from R4.generators.observation_generator import ObservationLabGenerator
...
class DiagnosticReportGenerator(Generator):
    ...
    def next(self):
        ...
        diagnostic_report.status = RandomStatus().next()
        diagnostic_report.subject = {"identifier": {"system": "urn:ietf:rfc:4122", "value": "123"}}
...
class LaboratoryReport(Generator):
    ...
    def __set_reference(self):
        self.diagnostic_report.subject = {"identifier": {"system": "urn:ietf:rfc:4122", "value": "123"}}

    def __set_basedOn(self):
        fhir_reference = Reference.parse_obj({"reference": self.random_service_request.next()})
    ...
    def __set_result(self, obs_id):
        fhir_reference = Reference.parse_obj(({"reference": "obs#{}".format(obs_id)}))
